...
updated: 2026-08-29
code_refs:
  - business-docs/wiki/shared/mvp-spec.md:15
---

> **Archived specification.** This is the original repository `README.md` — the written
> intent this whole wiki was traced from — moved here verbatim when the README was reduced
> to a pointer. Every citation that once read `README.md:N` now reads
> `business-docs/wiki/shared/mvp-spec.md:N+14`. Nothing below has been edited.
> It is a record of what we decided to build, never a description of what runs.
