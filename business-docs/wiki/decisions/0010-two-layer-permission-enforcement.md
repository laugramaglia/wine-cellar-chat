...
supersedes:
superseded_by:
source: business-docs/wiki/shared/mvp-spec.md:144
---
...
Do both, and be explicit about which is which (`business-docs/wiki/shared/mvp-spec.md:144-151`). Filtering serves the model; the handler check serves the system.
...
- The definition of done tests both independently: Fabian's token does not *see* `user_create` (`business-docs/wiki/shared/mvp-spec.md:424`), and calling it anyway is *rejected* (`business-docs/wiki/shared/mvp-spec.md:425`).
