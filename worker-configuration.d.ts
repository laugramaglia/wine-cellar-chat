/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 342ae701fb13b90ea6e185e423e4af9e)
// Runtime types generated with workerd@1.20260828.1 2026-01-15 nodejs_compat
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	HYPERDRIVE: Hyperdrive;
	BOOTSTRAP_SECRET: string;
	WINE_MCP: DurableObjectNamespace<import("./src/index").WineMcp>;
	MOCK_DB: DurableObjectNamespace<import("./src/index").MockDb>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "WineMcp" | "MockDb";
	}
